...
public class MovingCritterAttackController : MonoBehaviour
{
    ...
    [SerializeField]
    private float _propelFactor = 1.0f; // Propel factor is the proportion of the distance between the critter and the player crossed by the critter during the propel animation

    [SerializeField]
    private float _propelDuration = 0.2f;

    private float   _innerTime;
    private Vector3 _propelTargetVector;
