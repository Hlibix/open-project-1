...
public class Protagonist : MonoBehaviour
{
    ...
    [NonSerialized]
    public bool isRunning; // Used when using the keyboard to run, brings the normalised speed to 1
    ...
    private void RecalculateMovement()
    {
        ...
        if (_gameplayCameraTransform.isSet)
        {
            ...
            var cameraForward = _gameplayCameraTransform.Value.forward;
            cameraForward.y = 0f;
            var cameraRight = _gameplayCameraTransform.Value.right;
            cameraRight.y = 0f;
