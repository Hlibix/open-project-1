...
public class DropReward : StateAction
{
    ...
    {
        var specialDropItem = _dropRewardConfig.DropSpecialItem();
        ...
        // Drop items
        foreach (var dropGroup in _dropRewardConfig.DropGroups)
        {
    ...
    {
        var dropDice     = Random.value;
        var _currentRate = 0.0f;

        ItemSO     item       = null;
        GameObject itemPrefab = null;

        foreach (var dropItem in dropGroup.Drops)
        {
        ...
        var collectibleItem = Object.Instantiate(itemPrefab,
