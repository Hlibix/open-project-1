...
public class GetHitFlashingEffectAction : StateAction
{
    ...
    {
        var attackableEntity   = stateMachine.GetComponent<Damageable>();
        var getHitEffectConfig = attackableEntity.GetHitEffectConfig;
    ...
    public void ApplyHitEffect()
    {
        ...
        {
            var tintingColor = computeGetHitTintingColor();
    ...
    {
        var finalTintingColor = Color.Lerp(_baseTintColor, _flashingColor, _flashingColor.a);
        var tintingTiming     = (_getHitFlashingDuration - _innerFlashingTime) * _getHitFlashingSpeed       / _getHitFlashingDuration;
