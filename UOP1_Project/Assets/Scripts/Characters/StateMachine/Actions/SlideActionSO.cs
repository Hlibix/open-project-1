...
public class SlideAction : StateAction
{
    ...
    {
        var speed          = -Physics.gravity.y * Protagonist.GRAVITY_MULTIPLIER * .4f;
        var hitNormal      = _protagonist.lastHit.normal;
        var slideDirection = new Vector3(hitNormal.x, -hitNormal.y, hitNormal.z);
