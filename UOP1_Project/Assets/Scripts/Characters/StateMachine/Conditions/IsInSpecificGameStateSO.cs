...
public class IsInSpecificGameStateSO : StateConditionSO<IsInSpecificGameStateCondition>
{
    ...
    {
        return new IsInSpecificGameStateCondition();
    }
}

public class IsInSpecificGameStateCondition : Condition
{
    private IsInSpecificGameStateSO _originSO => (IsInSpecificGameStateSO)OriginSO; // The SO this Condition spawned from
