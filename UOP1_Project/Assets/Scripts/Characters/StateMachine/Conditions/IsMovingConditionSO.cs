...
public class IsMovingCondition : Condition
{
    ...
    private IsMovingConditionSO _originSO => (IsMovingConditionSO)OriginSO; // The SO this Condition spawned from
    ...
    {
        var movementVector = _protagonistScript.movementInput;
        movementVector.y = 0f;
