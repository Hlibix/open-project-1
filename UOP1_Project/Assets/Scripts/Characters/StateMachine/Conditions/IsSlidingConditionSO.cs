...
public class IsSlidingCondition : Condition
{
    ...
    protected override bool Statement()
    {
        ...
        var stepHeight     = _protagonistScript.lastHit.point.y - _protagonistScript.transform.position.y;
        var isWalkableStep = stepHeight <= _characterController.stepOffset;

        var currentSlope    = Vector3.Angle(Vector3.up, _protagonistScript.lastHit.normal);
        var isSlopeTooSteep = currentSlope >= _characterController.slopeLimit;
