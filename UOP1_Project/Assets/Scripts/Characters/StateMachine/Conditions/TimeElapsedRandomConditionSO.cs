...
public class TimeElapsedRandomCondition : Condition
{
    ...
    private TimeElapsedRandomConditionSO _originSO => (TimeElapsedRandomConditionSO)OriginSO; // The SO this Condition spawned from
    ...
    {
        return Time.time >= _startTime + timerLength;
    }
}