...
{
    [SerializeField]
    private LocalizedString _dialogueLine;

    [SerializeField]
    private ActorSO _actor;

    [SerializeField]
    private bool _pauseWhenClipEnds; //This won't work if the clip ends on the very last frame of the Timeline

    [SerializeField]
    public VoidEventChannelSO LineEndedEvent;
