...
namespace UOP1.EditorTools.Replacer
{
    internal class PrefabSelectionTreeView : TreeView
    {
        ...
        private List<TreeViewItem> rows  = new();
        private HashSet<string>    paths = new();

        private Dictionary<int, RenderTexture> previewCache    = new();
        private HashSet<int>                   renderableItems = new();

        private GameObjectPreview itemPreview = new();
        private GUIContent        itemContent = new();
