...
public partial class SceneSelector : EditorWindow
{
    private class ColorSelectorWindow : EditorWindow
    {
        ...
        private static readonly Color      kCellBackColor = new(0.0f, 0.0f, 0.0f, 0.1f);
        private static readonly Vector2    kCellOffset    = new(1.0f, 1.0f);
        private static readonly Vector2Int kCount         = new(5, 5);
        ...
        private void DrawMarkers()
        {
            ...
            for (var x = 0; x < kCount.x; ++x)
            {
                for (var y = 0; y < kCount.y; ++y)
                {
