...
namespace SceneSelectorInternal
{
    ...
    internal static class Helper
    {
        ...
        public static readonly Color kColorMarkerLightTint   = new(1.0f, 1.0f, 1.0f, 0.32f);
        ...
        private static readonly Dictionary<Type, Color> kDefaultMarkerColors = new()
        {
