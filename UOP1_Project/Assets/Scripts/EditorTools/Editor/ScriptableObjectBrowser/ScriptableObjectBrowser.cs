...
/// </summary>
internal class ScriptableObjectBrowser : EditorWindow
{
    private        SortedDictionary<string, System.Type> _types  = new();
    private        Dictionary<string, ScriptableObject>  _assets = new();
    ...
    private void GetTypes()
    {
        ...
        {
            var typeKey = SOs[i].GetType().Name;
    ...
    {
        var GUIDs = AssetDatabase.FindAssets("t:" + _types.ElementAt(_typeIndex).Value.FullName);
