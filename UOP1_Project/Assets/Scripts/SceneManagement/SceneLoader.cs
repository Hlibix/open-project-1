...
{
    [SerializeField]
    private GameSceneSO _gameplayScene;
    ...
    [SerializeField]
    private LoadEventChannelSO _loadMenu;

    [SerializeField]
    private LoadEventChannelSO _coldStartupLocation;
    ...
    [SerializeField]
    private VoidEventChannelSO _onSceneReady; //picked up by the SpawnSystem

    [SerializeField]
    private FadeChannelSO _fadeRequestChannel;
    ...
    private void LocationColdStartup(GameSceneSO currentlyOpenedLocation, bool showLoadingScreen, bool fadeScreen)
    {
        ...
        if (_currentlyLoadedScene.sceneType == GameSceneSO.GameSceneType.Location)
        {
            ...
            _gameplayManagerLoadingOpHandle = _gameplayScene.sceneReference.LoadSceneAsync(LoadSceneMode.Additive);
