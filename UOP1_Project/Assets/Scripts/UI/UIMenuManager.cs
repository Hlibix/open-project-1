...
public class UIMenuManager : MonoBehaviour
{
    ...
    [SerializeField]
    private UISettingsController _settingsPanel;

    [SerializeField]
    private UICredits _creditsPanel;

    [SerializeField]
    private UIMainMenu _mainMenuPanel;
    ...
    [SerializeField]
    private VoidEventChannelSO _continueGameEvent;
